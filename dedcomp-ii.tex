...
and if $U_1,U_2,\dotsc$ are open sets with $Y_n\equiv U_n\quad(n\in\N)$,
...
if~$\mathbb{1}_Y$ is the (pointwise) limit of a sequence
...
(\ref{4.5}, \ref{5.17}, \ref{6.5}, \ref{7.13}).
\begin{equation*}
\xymatrix@=4em{
\overline{\R[A]}
...
there is a unique clopen set $U\subseteq \Phi$
...
$\mathbb{1}_Y\circ\omega\equiv\hat{T}$.)
%
\item\label{7.14-III}
