...
\noindent \emph{Proof}\  $VT-VS=V(T-S)\in{\mathscr H}^+$,
by~\ref{5.20-2}. \xqed
%
...
\begin{enumerate}
\item\label{5.23-1}
$T^n \geq 0$ for every~$n$, and $I\geq T \geq T^2 \geq \dotsb$.
%
\item\label{5.23-2}
...
Let $T\in\mathscr A$.
\begin{itemize}
\item  The final lines of~\ref{5.19}
imply that $\sqrt{T^2}\in\mathscr A$.
...
Such a multiplicative linear function is a Riesz homomorphism,
...
If $A\in\mathscr A$ and $f\in\Cont{\Sp{A}}$, then
\begin{align*}
