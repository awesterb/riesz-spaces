...
%                  '3.10 1/2'
%
\begin{psec}{3.10.5}{Exercise}
Let $N\in\N$ and let~$E$ be an $N$-dimensional Archimedean
Riesz space.
Prove that~$E$ is Riesz isomorphic to~$\R^N$.
(Show that~$E$ is unitary;
that for $x,y\in E$ with $x\neq y$
there is a Riesz homomorphism~$\varphi\colon E\ra \R$
with $\varphi(x)\neq\varphi(y)$;
and that the ($N$-dimensional) vector space of all linear functionals
$E\ra \R$ has a basis consisting of Riesz homomorphisms.)
\end{psec}
%
%                  3.10
%
