...
we define the \keyword{variation} of $\varphi$ on $[a,b]$
\begin{multline*}
\Var{[a,b]}{\varphi}
  \ :=\  \sup\bigl\{ 
...
\begin{psec}{Comment}
\snote{Should this comment have a number?}
...
A \keyword{signed measure} on~$\mathcal A$
...
%
\begin{psec}{Theorem}
Let $\mathcal{A}$ be a $\sigma$-algebra on a set~$X$.
\begin{enumerate}
\item
\label{1.14-1}
...
\snote{The following paragraph should be (uniformly) indented.}
